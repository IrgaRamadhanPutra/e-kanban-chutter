...
<head>
    ...
    <title>Chuter Abnormality</title>
    <!-- Favicons -->
    ...
    <div class="custom-container mt-4">
        <div class="d-flex align-items-center justify-content-between">
            <div class="col">
                ...
                <a href="{{ route('index_chuter2_All') }}" class="btn btn-secondary" title="All Condition">
            ...
            <div class="col">
                <h3 class="ml-2 mt-0 mb-0"><b> ABNORMALITY </b></h3>
            </div>
            <div class="col">
        ...
        <div class="card-deck mt-3 mb-2 border-danger">
            {{-- <div id="cardCarousel" class="carousel slide" data-ride="carousel"> --}}
            <div id="cardCarousel" class="carousel slide" data-ride="carousel" data-interval="60000">
                <div class="carousel-inner" style="font-weight: bold;">
                                    ...
                                    <div class="col">
                                        <div class="table-responsive" data-toggle="modal" data-target="#popup-modal"
                                            ...
                                            <table class="table table-bordered mt-2 custom-table">
                                                ...
                                                {{-- @foreach ($data as $item)  ini untk semua nya data  --}}
                                                @foreach ($data->filter(function ($item) {
        return strpos($item['chutter_address'], 'O') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
    }) as $item)
                                                    @if (strpos($item['chutter_address'], 'O') === 0)
                                                        <tr>
                                    ...
                                    <div class="col">
                                        <div class="table-responsive" data-toggle="modal" data-target="#popup-modal"
                                            ...
                                            <table class="table table-bordered mt-2 custom-table">
                                                ...
                                                @foreach ($data->filter(function ($item) {
        return strpos($item['chutter_address'], 'N') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
    }) as $item)
                                                    <tr>
                                                        <td>{{ $item['chutter_address'] }}</td>
                                                        <td class="text-center"
                                                            style="background-color: @if ($item['balance'] < $item['min']) red @elseif($item['balance'] > $item['max']) #fab802 @endif">
                                                            {{ $item['balance'] }}</td>
                                                        <td style="background-color:rgb(0, 183, 255);">
                                    ...
                                    <div class="col">
                                        <div class="table-responsive" data-toggle="modal" data-target="#popup-modal"
                                            ...
                                            <table class="table table-bordered mt-2 custom-table">
                                                ...
                                                @foreach ($data->filter(function ($item) {
        return strpos($item['chutter_address'], 'M') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
    }) as $item)
                                                    @if (strpos($item['chutter_address'], 'M') === 0)
                                                        <tr>
                                                            <td>{{ $item['chutter_address'] }}</td>
                                                            <td class="text-center"
                                                                style="background-color:
                                                                @if ($item['balance'] < $item['min']) red
                                                                @elseif($item['balance'] > $item['max']) #fab802 @endif">
                                                                {{ $item['balance'] }}
                                                            </td>
                                                            <td style="background-color:rgb(0, 183, 255);">
                                                                {{ $item['jumlah_kanban'] }} /
                                    ...
                                    <div class="col">
                                        <div class="table-responsive" data-toggle="modal" data-target="#popup-modal"
                                            ...
                                            <table class="table table-bordered mt-2 custom-table">
                                                ...
                                                @foreach ($data->filter(function ($item) {
        return strpos($item['chutter_address'], 'L') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
    }) as $item)
                                                    @if (strpos($item['chutter_address'], 'L') === 0)
                                                        <tr>
                                                            <td>{{ $item['chutter_address'] }}</td>
                                                            <td class="text-center"
                                                                style="background-color:
                                    ...
                                    <div class="col">
                                        <div class="table-responsive" data-toggle="modal" data-target="#popup-modal"
                                            ...
                                            <table class="table table-bordered mt-2 custom-table">
                                                ...
                                                @foreach ($data->filter(function ($item) {
        return strpos($item['chutter_address'], 'K') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
    }) as $item)
                                                    @if (strpos($item['chutter_address'], 'K') === 0)
                                                        <tr>
                                                            <td>{{ $item['chutter_address'] }}</td>
                                                            <td class="text-center"
                                                                style="background-color:
        ...
        return strpos($item['chutter_address'], 'O') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
                                            ...
                                            @elseif($item['min'] > $item['balance']) red @endif;">
                                                                {{ $item['balance'] }}
                                                            </td>
                                                            <td class="text-center"
                                                                style="font-size: 14px; background-color:
        ...
        return strpos($item['chutter_address'], 'N') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
                                                    ...
                                                    @if (strpos($item['chutter_address'], 'N') === 0)
                                                        <tr>
                                                            <td style="font-size: 12px;">{{ $item['part_name'] }} -
                                                                {{ $item['part_number'] }}</td>
                                                            <td class="text-center"
        ...
        return strpos($item['chutter_address'], 'K') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
            ...
            <!-- Modal Structure -->
            {{-- <div id="popup-modal" class="popup-modal modal-xl">
