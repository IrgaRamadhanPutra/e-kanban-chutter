    ...
    <div class="custom-container mt-4">
        <div class="d-flex align-items-center justify-content-between">
            <div class="col">
                ...
                <a href="{{ route('index_chuter1_All') }}" class="btn btn-secondary" title="All Condition">
        ...
        return strpos($item['chutter_address'], 'J') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
    }) as $item)
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="table-responsive" data-toggle="modal" data-target="#popup-modal"
                                            ...
                                            <table class="table table-bordered mt-2 custom-table">
                                                ...
                                                @foreach ($data->filter(function ($item) {
        return strpos($item['chutter_address'], 'I') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
    }) as $item)
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="table-responsive" data-toggle="modal" data-target="#popup-modal"
                                            ...
                                            <table class="table table-bordered mt-2 custom-table">
                                                ...
                                                @foreach ($data->filter(function ($item) {
        return strpos($item['chutter_address'], 'H') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
    }) as $item)
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="table-responsive" data-toggle="modal" data-target="#popup-modal"
                                            ...
                                            <table class="table table-bordered mt-2 custom-table">
                                                ...
                                                @foreach ($data->filter(function ($item) {
        return strpos($item['chutter_address'], 'G') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
    }) as $item)
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="table-responsive" data-toggle="modal" data-target="#popup-modal"
                                            ...
                                            <table class="table table-bordered mt-2 custom-table">
                                                ...
                                                @foreach ($data->filter(function ($item) {
        return strpos($item['chutter_address'], 'F') === 0 && ($item['balance'] < $item['min'] || $item['balance'] > $item['max']);
    }) as $item)
