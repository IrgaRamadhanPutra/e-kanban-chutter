    ...
    <div class="custom-container mt-4">
        <div class="d-flex align-items-center justify-content-between">
            <div class="col">
                ...
                <a href="{{ route('index_chuter2_Abnormality') }}" class="btn btn-secondary" title="Abnormality">
